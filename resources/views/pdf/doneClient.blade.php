    ...
    <main>
        ...
        <div>
            <table style="width:100%;">
                ...
                <tr>
                    <td colspan="2" style="width:100%;text-align:center;font-weight:bold;font-size:18px;background-color:rgb(193, 190, 190);text-transform: uppercase">Détails après traitement du dossier</td>
                </tr>
                <tr>
        ...
        <div>
            <table style="width:100%;">
               <tr>
                ...
                <td style="width:50%; text-align: right">Dossier traité, le {{ $date }}</td>
               </tr>
            </table>
        </div>
